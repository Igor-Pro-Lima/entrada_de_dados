...
namespace entrada_de_dados {
    internal class Program {
        static void Main(string[] args) {
            ...
            nome1 = Console.ReadLine();//comentário: Comando para entrada de dados
            Console.Write("Digite o salário da primeira pessoa: ");
            salario1 = double.Parse(Console.ReadLine(), CI);

            Console.Write("Digite o nome da segunda pessoa: ");
            nome2 = Console.ReadLine();//comentário: Comando para entrada de dados
            ...
            Console.WriteLine("SALARI 1 = " + salario1.ToString("F2", CI));
